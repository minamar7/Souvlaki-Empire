...
namespace SouvlakiTycoon
{
    public class LocalizationManager : MonoBehaviour
    {
        ...
        private void InitializeTranslations()
        {
            ...
            AddTranslation("BUILD_UPGRADE", "BUILD & UPGRADE", "ΧΤΙΣΕ & ΑΝΑΒΑΘΜΙΣΕ", "BAUEN & VERBESSERN", "CONSTRUIRE & AMÉLIORER", "CONSTRUIR Y MEJORAR", "COSTRUISCI E MIGLIORA", "CONSTRUIR & MELHORAR", "СТРОЙ И  УΛΥЧШАЙ", "建造 & 升级", "बनाएं και अपग्रेड करें");
            ...
            AddTranslation("RECIPES", "RECIPES", "ΣΥΝΤΑΓΕΣ", "REZEPTE", "RECETTES", "RECETAS", "RICETTE", "RECEITAS", "РЕЦΕΠΤЫ", "食谱", "व्यंजन विधि");
            ...
            AddTranslation("DAILY_PROFIT", "DAILY PROFIT", "ΚΕΡΔΟΣ ΗΜΕΡΑΣ", "TÄGLICHER GEWINN", "PROFIT JOURNALIER", "GANANCIA DIARIA", "PROFITTO GIORNALIERO", "LUCRO DIÁRIO", "ЕЖЕДНЕВΝΑЯ ΠРИБЫЛЬ", "每日利润", "दैनिक लाभ");
            ...
            AddTranslation("UPGRADE_MEAT", "MEAT QUALITY", "ΠΟΙΟΤΗΤΑ ΚΡΕΑΤΟΣ", "FLEISCHQUALITÄT", "QUALITÉ DE VIANDE", "CALIDAD DE CARNE", "QUALITÀ DELLA CARNE", "QUALIDADE DA CARNE", "КАЧЕСТВО МЯСΑ", "肉质", "मांस की गुणवत्ता");
            ...
            // --- ΣΥΝΤΑΓΕΣ (Recipe book UI) ---
            AddTranslation("RECIPE_SOUVLAKI", "SOUVLAKI WRAP", "ΣΟΥΒΛΑΚΙ ΠΙΤΑ", "SOUVLAKI WRAP", "SOUVLAKI WRAP", "SOUVLAKI WRAP", "SOUVLAKI WRAP", "SOUVLAKI WRAP", "СУВЛАКИ КЕБАБ", "苏夫拉基卷饼", "सुवलाकी रैप");
            AddTranslation("RECIPE_GYRO", "GYRO PITA", "ΓΥΡΟΣ ΠΙΤΑ", "GYROS PITA", "GYRO PITA", "GYRO PITA", "GYRO PITA", "GYRO PITA", "ГИРОΣ ПИТА", "烤肉卷饼", "गाइरो पीटा");
            AddTranslation("RECIPE_FRIES", "CRISPY FRIES", "ΠΑΤΑΤΕΣ ΤΗΓΑΝΗΤΕΣ", "POMMES", "FRITES", "PATATAS FRITAS", "PATATINE", "BATATAS FRITAS", "КАРТОФЕЛЬ ФРИ", "炸薯条", "फ्रेंच फ्राइज़");
        }
